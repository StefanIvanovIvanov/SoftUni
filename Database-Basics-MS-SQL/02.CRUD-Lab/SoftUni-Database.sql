...
SELECT LastName
FROM Employees
WHERE ManagerID IN (4, 7, 12)

SELECT FirstName, LastName
FROM Employees
WHERE MiddleName IS NULL 

CREATE VIEW v_EmployeesHiredAfer2002 AS
SELECT *
FROM Employees
WHERE HireDate >= '12/312002'

SELECT * FROM v_EmployeesHiredAfer2002

SELECT FirstName, LastName
FROM v_EmployeesHiredAfer2002

--DELETE removes one or more values, whereas TRUNCATE deletes them all
/*
