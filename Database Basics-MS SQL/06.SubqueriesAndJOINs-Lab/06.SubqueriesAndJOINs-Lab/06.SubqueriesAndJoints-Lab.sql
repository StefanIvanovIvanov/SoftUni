...
--LEFT OUTER JOIN
--Takes ALL values from the first table. IF they don't have a value in the second table it replaces it with NULL
SELECT *
FROM Employees AS emp
...
--RIGHT OUTER JOIN
--Takes ALL values from the second table. IF they don't have a value in the first table it replaces it with NULL
SELECT *
FROM Employees AS emp
...
SELECT *
FROM Employees AS emp
FULL JOIN Departments AS dept
ON dept.DepartmentID = emp.DepartmentID

--CROSS JOINT
--Joins every row in the first table with every row in the second table
SELECT *
FROM Employees AS emp
...
WITH CTE_EmployeesNames (FirstName, LastName)
AS
(
