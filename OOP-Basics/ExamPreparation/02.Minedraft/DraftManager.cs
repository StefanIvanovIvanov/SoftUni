...
public class DraftManager
{
    ...
    public string Check(List<string> arguments)
    {
        ...
        if (harvesters.ContainsKey(id))
        {
            ...
            var harvester = (Harvester)unit;
            string type = unit is SonicHarvester ? "Sonic" : "Hammer";
        ...
        if (providers.ContainsKey(id))
        {
            ...
            var provider = (Provider)unit;
            string type = unit is PressureProvider ? "Pressure" : "Solar";
